...
public class BeanElementInfo extends AbstractElementInfo implements ElementInfo {
    ...
    private BeanElementInfo(InterfaceInfo interfaceInfo, ElementSet elementSet, String fullName) {
        super(interfaceInfo, elementSet, fullName);
    }

    public static BeanElementInfoBuilder builder(InterfaceInfo interfaceInfo, ElementSet elementSet, String fullName) {
        return new BeanElementInfoBuilder(interfaceInfo, elementSet, fullName);
    }
    ...
    public static class BeanElementInfoBuilder {
        ...
        private BeanElementInfoBuilder(InterfaceInfo interfaceInfo, ElementSet elementSet, String fullName) {
        ...
        public BeanElementInfoBuilder extras(Properties extras) {
            this.extras = extras;
            return this;
        }
        ...
        public BeanElementInfo build() {
            BeanElementInfo value = new BeanElementInfo(interfaceInfo, elementSet, fullName);
            if (desc == null) {
                value.desc = fullName;
            } else {
                value.desc = desc;
