...
public class FormElementInfo extends AbstractElementInfo implements ElementInfo {
    ...
    private FormElementInfo(InterfaceInfo interfaceInfo, ElementSet elementSet, String fullName) {
        super(interfaceInfo, elementSet, fullName);
    }

    public static FormElementInfoBuilder builder(InterfaceInfo interfaceInfo, ElementSet elementSet, String fullName) {
        return new FormElementInfoBuilder(interfaceInfo, elementSet, fullName);
    }
    ...
    public static class FormElementInfoBuilder {
        ...
        private FormElementInfoBuilder(InterfaceInfo interfaceInfo, ElementSet elementSet, String fullName) {
        ...
        public FormElementInfoBuilder extras(Properties extras) {
            this.extras = extras;
            return this;
        }
        ...
        public FormElementInfo build() {
            FormElementInfo value = new FormElementInfo(interfaceInfo, elementSet, fullName);
            if (desc == null) {
                value.desc = fullName;
            } else {
                value.desc = desc;
            ...
            value.beanClass = beanClass;
            value.elements.addAll(elements);
            return value;
        }
