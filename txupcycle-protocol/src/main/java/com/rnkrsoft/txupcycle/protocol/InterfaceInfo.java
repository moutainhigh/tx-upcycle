...
public class InterfaceInfo implements Comparable<InterfaceInfo> {
    ...
    public InterfaceInfo(DocScanner docScanner, ServiceInfo serviceInfo, String name, String version, String desc, String usage, String className, String methodName, Class requestClass, Class responseClass) {
    ...
    public String toString() {
        return MessageFormatter.format("{}:{}({})={}.{}", name, version, desc, className, methodName);
    }
}
