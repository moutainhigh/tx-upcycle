 ...
 */
public class UpcycleElementSet {
    /**
     * 元素集合类型，取值为Request何Response之一
     */
    @Getter
     ...
     */
    @Getter
    final Map<String, UpcycleElementInfo> fullNameElements = new HashMap();
    /**
     * 业务字段
     */
    ...
    /**
     * 新建一个元素集合
     * @param elementClassName 元素集合对应的Java对象
     * @param elementSetType 元素集合类型
     */
    UpcycleElementSet(String elementClassName, ElementSetType elementSetType) {
     ...
     * @return 元素列表
     */
    public List<UpcycleElementInfo> getElements() {
        return elements;
    }
}
