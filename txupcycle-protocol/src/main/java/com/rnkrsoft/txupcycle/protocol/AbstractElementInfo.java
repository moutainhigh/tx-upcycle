 ...
 * 抽象的元素信息对象
 */
@ToString(exclude = {"interfaceInfo", "docScanner"})
public abstract class AbstractElementInfo implements ElementInfo {
    @Getter
    protected final DocScanner docScanner;
    /**
     * 字段的完整名称，使用类全限定名
     */
    @Getter
    ...
    public AbstractElementInfo(InterfaceInfo interfaceInfo, ElementSet elementSet, String fullName) {
        this.docScanner = interfaceInfo.getDocScanner();
