...
public class ElementSet {
     ...
     * 分页字段
     */
    final List<ElementInfo> pagination = new ArrayList();
    /**
     * 应答结果字段
     */
     ...
     * @return 分页字段
     */
    public List<ElementInfo> getPagination() {
        return pagination;
    }
     ...
     * @return
     */
    public List<ElementInfo> getResult() {
        return result;
    }
     ...
     * 根据字段完整名称查询
     *
     * @param fullName 完整名称 形如 request.name1 或 response.age1
     * @return 字段信息
     */
